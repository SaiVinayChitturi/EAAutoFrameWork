...
namespace EAAutoFrameWork.Helpers
{
    ...
    public class HtmlTableHelper
    {
            ...
            foreach (var row in rows)
            {
                ...
                if (colDatas.Count != 0)
                {
                    foreach (var colValue in colDatas)
                    {
                        ...
                        {
                            RowNumber = rowIndex,
                            ColumnName = colDatas[colIndex].Text != "" ?
                                         colDatas[colIndex].Text : colIndex.ToString(),
        ...
        {
            int rowNumber = 1;// GetDynamicRowNumber(refColumnName, refColumnValue);
        ...
        //private static int GetDynamicRowNumber(string columnName, string columnValue)
        //{
        //    int rownumber;
        //    //dynamic row
